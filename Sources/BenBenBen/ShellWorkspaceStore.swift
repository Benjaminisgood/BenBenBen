...
final class ShellWorkspaceStore: ObservableObject {
    ...
    private static let activeWorkspaceKey = "benbenben.activeShellWorkspace"
    private static let legacyActiveWorkspaceKeys = ["notchwow.activeShellWorkspace", "notchNotes.activeShellWorkspace"]
    ...
    init() {
        ...
        let savedID = AppDefaults.string(forKey: Self.activeWorkspaceKey, migrating: Self.legacyActiveWorkspaceKeys)
    ...
    func selectWorkspace(_ id: String) {
        ...
        AppDefaults.set(id, forKey: Self.activeWorkspaceKey, removing: Self.legacyActiveWorkspaceKeys)
    }
    ...
    func syncFromDisk() {
        ...
        if !workspaces.contains(where: { $0.id == activeWorkspaceID }) {
            ...
            AppDefaults.set(activeWorkspaceID, forKey: Self.activeWorkspaceKey, removing: Self.legacyActiveWorkspaceKeys)
        }
