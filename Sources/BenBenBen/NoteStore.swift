...
final class NoteStore: ObservableObject {
    ...
    private static let textKey = "benbenben.text"
    private static let legacyTextKeys = ["notchwow.text", "notchNotes.text"]
    private static let activeFilePathKey = "benbenben.activeFilePath"
    private static let legacyActiveFilePathKeys = ["notchwow.activeFilePath", "notchNotes.activeFilePath"]
    ...
    init(markdownRoot: URL = WorkspacePaths.markdownRoot) {
        ...
        let legacyText = AppDefaults.string(forKey: Self.textKey, migrating: Self.legacyTextKeys)
        ...
        let activePath = AppDefaults.string(forKey: Self.activeFilePathKey, migrating: Self.legacyActiveFilePathKeys)
    ...
    private func save() {
        ...
        if let activePath = activeTab.filePath {
            AppDefaults.set(activePath, forKey: Self.activeFilePathKey, removing: Self.legacyActiveFilePathKeys)
        }
        AppDefaults.set(text, forKey: Self.textKey, removing: Self.legacyTextKeys)
    }
