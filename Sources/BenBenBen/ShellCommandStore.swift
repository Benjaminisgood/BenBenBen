...
final class ShellCommandStore: ObservableObject {
    ...
    private static let selectedToolkitKey = "benbenben.selectedShellToolkit"
    private static let legacySelectedToolkitKeys = ["notchwow.selectedShellToolkit", "notchNotes.selectedShellToolkit"]
    ...
    init(benshellRootURL: URL = WorkspacePaths.benshellRoot) {
        ...
        selectedToolkitName = AppDefaults.string(forKey: Self.selectedToolkitKey, migrating: Self.legacySelectedToolkitKeys)
            ?? "benshell"
        refresh()
    }
    ...
    func selectToolkit(_ name: String) {
        ...
        AppDefaults.set(name, forKey: Self.selectedToolkitKey, removing: Self.legacySelectedToolkitKeys)
    }
