...
final class CondaEnvironmentStore: ObservableObject {
    ...
    private static let selectedEnvironmentKey = "benbenben.selectedCondaEnvironment"
    private static let legacySelectedEnvironmentKeys = ["notchwow.selectedCondaEnvironment", "notchNotes.selectedCondaEnvironment"]
    ...
    init(condaRootURL: URL = WorkspacePaths.condaRoot) {
        ...
        selectedEnvironmentName = AppDefaults.string(forKey: Self.selectedEnvironmentKey, migrating: Self.legacySelectedEnvironmentKeys)
            ?? "base"
        refresh()
    }
    ...
    func select(_ name: String) {
        ...
        AppDefaults.set(name, forKey: Self.selectedEnvironmentKey, removing: Self.legacySelectedEnvironmentKeys)
    }
